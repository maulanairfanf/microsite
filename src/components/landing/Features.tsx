...
const features = [
  {
    ...
    description: "Tidak perlu coding. Buat halaman professional dalam hitungan menit dengan antarmuka yang intuitif.",
  ...
  },
  {
    ...
    description: "Pilih tema yang sesuai dengan kepribadianmu. Tampilkan identitasmu dengan warna dan font favorit.",
  ...
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.19 8.688a4.5 4.5 0 011.562 8.29l4.12 4.121m-4.742-7.121l4.121-4.121a4.5 4.5 0 11-6.364-6.364l-1.121 1.121M5.55 5.55A17.92 17.92 0 0112 4c2.874 0 5.59.738 8.03 2.05" />
      </svg>
    ),
    title: "Link Unlimited",
    description: "Tambahkan sebanyak mungkin tautan. Dari media sosial hingga toko online, semua dalam satu tempat.",
  ...
  },
  {
    ...
    description: "Ketahui berapa banyak yang mengakses halamanmu. Data sederhana yang membantu kamu memahami audiens.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
            Kenapa <span className="bg-gradient-to-r from-violet-600 to-pink-600 bg-clip-text text-transparent">Halamanku</span>?
          </h2>

...
const superAdminNavItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m0 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m2 0h1m-2 8h1" />
      </svg>
    ),
  },
  {
...
const tenantAdminNavItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1h-6a1 1 0 01-1-1v-6z" />
      </svg>
    ),
  },
  {
...
export function Sidebar({ role, tenantName, userName, userEmail, isImpersonating }: SidebarProps) {
  ...
  const navItems = role === 'super_admin' && !isImpersonating ? superAdminNavItems : tenantAdminNavItems;

  const branding = role === 'super_admin' && !isImpersonating
    ? 'Halamanku'
    : `${tenantName || 'Tenant'}`;
        ...
        <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
          {navItems.map((item) => {
            ...
            const isActive = pathname === item.href ||
              (!isExactRoute && pathname.startsWith(item.href + '/'));

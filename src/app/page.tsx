import { HeroComponent, LinktreeComponent, ProductsShowcaseComponent, ProductsCatalogComponent, BannerComponent } from "@/types/components";
...
export default function Home() {
  ...
  const components = [hero, banner, linktree, showcase, catalog];
